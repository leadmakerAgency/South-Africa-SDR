...
CONTACT_CTA = "/contact/"
LLMS_TXT_URL = "https://southafricasdr.com/llms.txt"
CONSENT_SCRIPTS = """  <script src="/consent-config.js" defer></script>
...
.cookie-table th, .cookie-table td { border: 1px solid var(--hairline); padding: 10px 12px; text-align: left; vertical-align: top; }
  ...
  <div class="container footer-container">
    ...
    <div class="footer-bottom">
      ...
      <nav class="footer-legal" aria-label="Legal">
        ...
        <button type="button" class="footer-cookie-settings" data-cc-settings>Cookie settings</button>
      </nav>
    </div>
  </div>
</footer>"""
...
<head>
  ...
  {favicon}
  {fonts}
  <link rel="describedby" href="{LLMS_TXT_URL}">
  {extra_head}
  <style>
{BASE_CSS}
{EXTRA_CSS}
...
<div class="contact-info-item"><svg viewBox="0 0 24 24" fill="none"><path d="M6.5 4h3l1.2 4.2-2 1.2a13 13 0 0 0 5.1 5.1l1.2-2 4.2 1.2v3a2 2 0 0 1-2 2C10.4 18.7 5.3 13.6 5.3 6.5A2 2 0 0 1 6.5 4Z" stroke="currentColor" stroke-width="1.6"/></svg><a href="tel:+447397601087" style="color:inherit;">+44 7397 601087</a></div>
...
{closing}
    ...
    legal_pages = [
        ("privacy", "Privacy Policy", """<h2>Introduction</h2><p>South Africa SDR (&quot;we&quot;, &quot;us&quot;) respects your privacy. This policy explains how we collect, use, store, and protect personal information when you visit southafricasdr.com, submit a form, or speak with our team. We operate from Cape Town, South Africa, and serve clients in the United Kingdom, European Union, United States, Australia, and other markets.</p><h2>Information we collect</h2><p><strong>Information you provide:</strong> name, work email, company, phone number (if supplied), and message content when you use our contact form, book a call, or email us.</p><p><strong>Technical information:</strong> IP address, browser type, device information, and pages visited when you use our website. If you accept analytics cookies, we may collect usage data through configured analytics tools (see our <a href="/cookies/">Cookie Policy</a>).</p><p><strong>Third-party form processing:</strong> Contact submissions are processed by Formspree (formspree.io), which receives the data you submit. Formspree acts as a processor on our behalf.</p><h2>How we use your information</h2><ul><li>To respond to enquiries and schedule discovery calls</li><li>To provide and improve our outsourced SDR and related services</li><li>To understand website traffic and marketing performance (only with your cookie consent)</li><li>To comply with legal obligations</li></ul><p>We do not sell your personal data.</p><h2>Lawful bases (GDPR)</h2><p>For visitors in the UK and EU: we process enquiry data on the basis of <strong>legitimate interest</strong> (responding to your request) and, where applicable, <strong>consent</strong> (marketing cookies and optional communications). You may withdraw consent at any time via our cookie settings or by contacting us.</p><h2>POPIA (South Africa)</h2><p>As a South African operator, we process personal information in line with the Protection of Personal Information Act (POPIA). We collect information for defined purposes, keep it secure, and only retain it as long as necessary.</p><h2>Cookies and tracking</h2><p>We use essential cookies to remember your cookie preferences. Analytics and marketing tools load only if you consent. See our <a href="/cookies/">Cookie Policy</a> for details and to change your choices at any time.</p><h2>Third-party services</h2><ul><li><strong>Formspree</strong> — contact form delivery</li><li><strong>Google Fonts</strong> — typography (requests to Google servers; no advertising cookies from us)</li><li><strong>Google Tag Manager / Analytics / Ads</strong> — only when configured and you consent to analytics or marketing cookies</li><li><strong>Meta Pixel / LinkedIn Insight Tag</strong> — only when configured and you consent to marketing cookies</li></ul><h2>Data retention</h2><p>Enquiry and contact records are kept for as long as needed to respond, manage a sales conversation, or deliver services, and as required by law. Cookie consent records are stored for up to 13 months.</p><h2>International transfers</h2><p>Your data may be processed in South Africa, the United Kingdom, the European Union, or the United States depending on our tools and service providers. We take reasonable steps to ensure appropriate safeguards where required.</p><h2>Your rights</h2><p>Under POPIA and GDPR you may request access, correction, deletion, restriction, or portability of your personal data, and object to certain processing. To exercise these rights, call <a href="tel:+447397601087">+44 7397 601087</a> or use our <a href="/contact/">contact form</a>.</p><h2>Contact</h2><p>South Africa SDR, Cape Town, South Africa. Phone: <a href="tel:+447397601087">+44 7397 601087</a>.</p>"""),
        ("terms", "Terms of Service", "<h2>Agreement</h2><p>By using southafricasdr.com, you agree to these terms. If you do not agree, please do not use the site.</p><h2>Services</h2><p>South Africa SDR provides outsourced sales development and related services. Specific terms for engagements are agreed in separate service agreements.</p><h2>Website content</h2><p>Content on this site is for general information. We make reasonable efforts to ensure accuracy but do not guarantee completeness.</p><h2>Limitation of liability</h2><p>We are not liable for indirect or consequential damages arising from use of this website.</p><h2>Governing law</h2><p>These terms are governed by the laws of South Africa.</p><h2>Contact</h2><p><a href=\"tel:+447397601087\">+44 7397 601087</a></p>"),
        ("cookies", "Cookie Policy", """<h2>What are cookies</h2><p>Cookies are small text files stored on your device when you visit a website. Similar technologies (such as local storage) may be used to remember your preferences.</p><h2>How we use cookies</h2><p>We group cookies into three categories:</p><ul><li><strong>Essential</strong> — required to remember your cookie consent choice and operate basic site features. These do not require consent.</li><li><strong>Analytics</strong> — help us understand how visitors use the site (e.g. Google Analytics via Google Tag Manager). Loaded only if you accept analytics cookies.</li><li><strong>Marketing</strong> — used to measure ad performance and build audiences (e.g. Meta Pixel, LinkedIn Insight Tag). Loaded only if you accept marketing cookies.</li></ul><p>Non-essential cookies are <strong>blocked by default</strong> until you choose Accept all, Reject non-essential, or save custom preferences in our cookie banner.</p><h2>Cookies we set</h2><table class="cookie-table"><thead><tr><th>Name</th><th>Provider</th><th>Purpose</th><th>Duration</th><th>Category</th></tr></thead><tbody><tr><td>sa_sdr_consent</td><td>South Africa SDR</td><td>Stores your cookie consent choices</td><td>Up to 13 months</td><td>Essential</td></tr><tr><td>sa_sdr_consent (localStorage)</td><td>South Africa SDR</td><td>Backup storage for consent preferences</td><td>Up to 13 months</td><td>Essential</td></tr><tr><td>_ga, _ga_*</td><td>Google</td><td>Analytics — distinct users and sessions</td><td>Up to 2 years</td><td>Analytics (consent required)</td></tr><tr><td>_fbp</td><td>Meta</td><td>Marketing — ad delivery and measurement</td><td>Up to 3 months</td><td>Marketing (consent required)</td></tr><tr><td>li_* / bcookie</td><td>LinkedIn</td><td>Marketing — campaign analytics</td><td>Varies</td><td>Marketing (consent required)</td></tr></tbody></table><p>Analytics and marketing cookies appear only when the relevant tool is configured on our site <strong>and</strong> you have granted consent. If no tracking IDs are configured, only essential consent cookies are used.</p><h2>Third parties that do not use our cookie banner</h2><p>When you submit our contact form, data is sent directly to <strong>Formspree</strong> (formspree.io). That is a form submission, not a cookie set by our banner. Google Fonts may receive your IP address when fonts load.</p><h2>Managing cookies</h2><p>You can change your choices at any time by clicking <strong>Cookie settings</strong> in the site footer, or via your browser settings. Rejecting non-essential cookies will not prevent you from using the site.</p><h2>Google Consent Mode</h2><p>When Google tools are enabled, we use Google Consent Mode v2 so tags respect your analytics and marketing choices.</p><h2>Contact</h2><p>Questions about cookies? Call <a href="tel:+447397601087">+44 7397 601087</a> or see our <a href="/privacy/">Privacy Policy</a>.</p>"""),
    ]
